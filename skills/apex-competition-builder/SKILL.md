...
- [ ] Metric + baselines (`defaults.baseline_raw_score`) + anti-Goodhart gates defined. No scored term measured in wall-clock time — speed, if it counts, counted in host-independent units (steps, calls, moves, tokens, operations).
